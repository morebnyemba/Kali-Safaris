  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white via-[#fff7ec] to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#ffba5a]/15 blur-3xl rounded-full" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#ff9800]/10 blur-3xl rounded-full" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            <div className="bg-white/75 backdrop-blur-lg border border-white/60 shadow-xl rounded-2xl p-8 md:p-10 relative overflow-hidden">
              ...
              <p className="relative text-sm uppercase tracking-[0.3em] text-[#ff9800] font-semibold mb-4">
                About Kalai Safaris
              </p>
              <h2 className="relative text-2xl md:text-3xl font-bold mb-6 text-gray-900 leading-relaxed">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff9800] to-[#ffba5a]">Kalai</span> &quot;the cry of the fish eagle&quot;, is a boating safari company on the mighty Zambezi above the Victoria Falls.
              </h2>
              ...
              <Link 
                href="#sunrise" 
                className="relative inline-block bg-gradient-to-r from-[#ffba5a] to-[#ff9800] hover:from-[#ff9800] hover:to-[#ff7700] text-black font-bold py-3 px-8 rounded-full transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5"
              >
